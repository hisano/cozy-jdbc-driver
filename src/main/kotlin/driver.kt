...
private class CozyConnection(host: String, port: Int, database: String, username: String, password: String) :
    Connection {
...
private class CozyStatement(val connection: CozyConnection) : Statement {
...
private class CozyResultSet(val queryResult: QueryResult) : ResultSet {
