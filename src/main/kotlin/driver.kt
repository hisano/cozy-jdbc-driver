...
class CozyDriver: Driver {
    override fun connect(url: String, info: Properties?): Connection? {
        ...
        val matchResult = "jdbc:cozy://([a-zA-Z0-9.-]+)(:\\d+)?/([a-zA-Z0-9._-]+)".toRegex().matchEntire(url) ?: return null
...
private class CozyConnection(host: String, port: Int, database: String, user: String, password: String) : Connection {
