...
internal class CozyStatement(
    ...
    override fun executeUpdate(sql: String?): Int {
        ...
        mutex.withLock {
            val completableFuture = connection.concreteConnection.sendQuery(sql)
            this.completableFuture.set(completableFuture)
            val resultSet = if (isNoQueryTimeout) completableFuture.get() else completableFuture.get(queryTimeoutSeconds.toLong(), SECONDS)
            return resultSet.rowsAffected.toInt()
        }
    }
